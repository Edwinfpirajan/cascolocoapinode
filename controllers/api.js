...
const getProducts = async () => {
    try {
        const { data: response } = await axios.get(
            `https://tienda.scsintercom.com/api/products?display=[id,price,name,reference,stock_availables[id,id_product_attribute]]&output_format=JSON&ws_key=S7UVTH5XIPYEPRWRHD5SUZNVZKT8SU1I`
        );
        const { data: response2 } = await axios.get(
            `https://tienda.scsintercom.com/api/combinations?display=[id, id_product,quantity,reference,product_option_values[id]]&output_format=JSON&ws_key=S7UVTH5XIPYEPRWRHD5SUZNVZKT8SU1I`
        );
        const { data: response3 } = await axios.get(
            `https://tienda.scsintercom.com/api/product_option_values?display=[id,name]&output_format=JSON&ws_key=S7UVTH5XIPYEPRWRHD5SUZNVZKT8SU1I`
        );
